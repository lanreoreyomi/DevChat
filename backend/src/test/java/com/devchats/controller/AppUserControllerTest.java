...
public class AppUserControllerTest {
  ...
  public void setup() {
    ...
    user_one.setFirstName("Updated_firstName");
    ...
    when(appUserController.updateUserAddress(any(), any())).thenReturn(
        ResponseEntity.ok(convertAddressEntityToDTO(address)));
  ...
  public void testCreateUser() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders
        ...
        .andDo(print())
        .andExpect(MockMvcResultMatchers.jsonPath("$.userId").value(user_one.getUserId()));
  ...
  LocalDate birthday = LocalDate.of(1998, 1,2);
  private UserDetails createUserDetails() {
    return new UserDetails("123-345-789", "Love cats and dogs",
        "Front End Developer", "Masters", birthday);
  }
